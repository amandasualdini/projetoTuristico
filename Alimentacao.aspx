<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alimentacao.aspx.cs" Inherits="projetoTuristico.Alimentacao" %>
        ...
        <form id="form1" runat="server">
            <article class="kanban-entry grab" id="item1" draggable="true">
                <div class="kanban-entry-inner">
                    <div class="kanban-label">
                        <h2><a href="#" style="padding: 12px">Alimentação</a> <span></span></h2>
                        <p></p>
                    </div>
                </div>
            </article>
            <div class="form-group col-md-5">
                ...
                <asp:TextBox class="form-control" ID="TxtIdReq"
                    runat="server" placeholder="Informe o id da requisição">
                </asp:TextBox>
            </div>
             <div class="form-group col-md-5">
                <label for="descricao">Informe o tipo</label>
                <asp:TextBox class="form-control" ID="TxtTipo"
                    runat="server" placeholder="Informe o tipo">
                </asp:TextBox>
            </div>
            <div class="form-group col-md-5">
                <label for="descricao">Informe a quantidade</label>
                <asp:TextBox class="form-control" ID="TxtQtde"
                    runat="server" placeholder="Informe a quantidade">
                </asp:TextBox>
            </div>
            <div class="form-group col-md-5">
